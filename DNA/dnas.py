...
kr = DNA.LINE()
#kr.login(qr=True)
kr.login(token='EpGdSrEkALFn7g6v7Nyc.wCH6QtFizyLaDm2DOFHvda.KzAhnl7deerLaMB/XJn/13qPyfjx/Y2TG79u/Go0XYY=')
kr.loginResult()

print "╔═════════════════════════\n║╔════════════════════════\n║╠❂➣ R_OthOy MULAI NGE'GEBOY\n║╚════════════════════════\n╚═════════════════════════"
reload(sys)
sys.setdefaultencoding('utf-8')

helpmsg ="""
╔═════════════
║ 💀 tɛǟʍ kǟℓ๏ng ʀ๏ck ɮʀ๏tɛʀh๏๏d 💀 
╠═════════════
║ Owner : ʀ_๏th๏ʏ
║ http://line.me/ti/p/upcgkpm6La
╠═════════════
║╔════════════
║╠❂➣Me
║╠❂➣Runtime
...
Bots=[mid]
owner=["u59c87aa937c865894074cd9da1f8550c",mid]
admin=["u59c87aa937c865894074cd9da1f8550c",mid]
baby=["u1b90d630c5415bb72f8341c3258b3cf4","u170fa1c64fa9e940989ecca10f8d9eda","u82a1357f47e518a6f7494824e704ee73","ufa98321efbc4e1474b139aba28fe3c41","u1684ecd7ecf246f158cb6591ef803753"]#chery/barby/ranita
...
wait = {
    ...
    'message':"""Tengkiuw..""",
    "lang":"JP",
    "comment":"👉ąµţ๏ℓɨЌ€ By ✰ tɛǟʍ kǟℓ๏ng ʀ๏ck ɮʀ๏tɛʀh๏๏d ✰ (＾ω＾) ⭐👈 »»» http://line.me/ti/p/upcgkpm6La «««",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
        ...
        if op.type == 26:
            ...
            if "MENTION" in msg.contentMetadata.keys() != None:
                 if wait['detectMention'] == True:
                     ...
                     balas = ["Don't Tag Me! iam Bussy! ",cName + "yupz.. ?",cName + " pm aj, othoynya lagi anu..", "nah ? ", cName + " Hadiiir...", + cName, "Geboooy.. " + cName + ">,<", "Yuhuu " + cName + "?","Whatsup" + cName + "?"]
            ...
            if "MENTION" in msg.contentMetadata.keys() != None:
                 if wait['kickMention'] == True:
                     contact = kr.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag Me!! Im Busy, ",cName + " Ngapain Ngetag?, ",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja, ", "-_-, ","Dee lagi off, ", cName + " Kenapa Tag saya?, ","SPAM PC aja, " + cName, "Jangan Suka Tag gua, " + cName, "Kamu siapa, " + cName + "?", "Ada Perlu apa, " + cName + "?","Tag doang tidak perlu., "]
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                kr.sendMessage(msg)
                    ...
                    a = msg.text.replace(".id","")
                    b = urllib.quote(a)
                    kr.sendText(msg.to,"「 Ni id Othoy 」\n" "IG : @r_othoy 👉 Smule : @r_othoy 👉 Line : r_othoy666")
                    kr.sendText(msg.to,"https://www.instagram.com/r_othoy" + b)
                    kr.sendText(msg.to,"「 Follow n I'll follback 」\n" "Type:Mencari Info\nStatus: Sukses")
                    
                    #======================== FOR COMMAND MODE ON STARTING ==========================#
            elif msg.text.lower() == 'modes on':
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                msg.contentMetadata = {'mid': "uacdbc0df971bbda9e5ee6f992ec74088"}
                kr.sendMessage(msg)
                kr.sendText(msg.to,'❂➣ Creator yang koplak dan nyebelin')
...
#=====================================
                ...
                if msg.toType == 2:
                  ...
                  while(t):
                    ...
                    t-=1
#==============================================
            elif "Pm kribo @" in msg.text:
                _name = msg.text.replace("Pm kribo @","")
                _nametarget = _name.rstrip(' ')
                gs = kr.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
                       kr.sendText(g.mid,'Assalamualaikum')
                       kr.sendText(g.mid,'Ada orang ga')
                       kr.sendText(g.mid,'Kmana sih')
                       kr.sendText(g.mid,'Yuhuuu')
                       kr.sendText(g.mid,'Assalamualaikum')
                       kr.sendText(g.mid,'Tok Tok Tok')
                       kr.sendText(g.mid,'Pm kribo noh')
                       kr.sendText(g.mid,'Assalamualaikum')
                       kr.sendText(g.mid,'Read doNg')
                       kr.sendText(g.mid,'Aduuuuh')
                       kr.sendText(g.mid,'Pliss')
                       kr.sendText(g.mid,'Read atUh')
                       kr.sendText(g.mid,'Assalamualaikum')
                       kr.sendText(g.mid,'scrool uy')
                       kr.sendText(g.mid,'yowees byee')
                       kr.sendText(msg.to, "Gebooy")
                       print " Spammed !"
...
#==============================================================================#
                ...
                if msg.to in wait2['readPoint']:
                        ...
                        with open('sider.json', 'w') as fp:
                         ...
                         kr.sendText(msg.to,"Mulai geboy Toys")
                else:
                    try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
                    ...
                    with open('sider.json', 'w') as fp:
                     json.dump(wait2, fp, sort_keys=True, indent=4)
                     kr.sendText(msg.to, "Wokeh redeh geboy ya:\n" + datetime.now().strftime('%H:%M:%S'))
                     print wait2

                    
            elif msg.text in ["Geboy off"]:
                if msg.to not in wait2['readPoint']:
                    kr.sendText(msg.to,"Brenti geboy")
                else:
                    try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
                          ...
                          pass
                    kr.sendText(msg.to, "Geboy nya brenti dulu encok kumat uy:\n" + datetime.now().strftime('%H:%M:%S'))
                 ...
                 if msg.toType == 2:
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2['ROM'][msg.to].items() == []:
                             kr.sendText(msg.to, "Kang ngintip:\nNone")
                        else:
                            chiya = []
                            for rom in wait2['ROM'][msg.to].items():
                                chiya.append(rom[1])
                        ...
                        print zxc
                        msg.text = xpesan+ zxc + "\nNgintip: %s\nKabur: %s"%(wait2['setTime'][msg.to],datetime.now().strftime('%H:%M:%S'))
                        ...
                        kr.sendText(msg.to, "Uups geboy lom bisa dimulai toys")
              ...
              if msg.from_ in admin:
	           ...
	           if msg.from_ in admin:
                ...
                try:
                    ...
                    html = requests.get('https://www.instagram.com/r_othoy' + instagram + '/?')
                    ...
                    post = "Post: " + text[4] + "\n"
                    link = "Link: " + "https://www.instagram.com/r_othoy" + instagram
