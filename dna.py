...
kr = DNA.LINE()
#kr.login(qr=True)
kr.login(token='EpVDB6CCkPkOAKYiJYX4.g5dwmmvbw7CVG0hdjyS89a.alYiNpxjzu49QMRYWOshCvepGM2Vg3CTD0EVkApFFiI=')#r1
kr.loginResult()

kr1 = DNA.LINE()
#kr1.login(qr=True)
kr1.login(token='EpntmZjY9FY4Qij4gyaa.fW/HXK/P6ucyNSYHd42E2G./WXOxrKKxWD7yCxRK7g18wcZ6xBHZcCYtXWk+tO8el8=')#r2
kr1.loginResult()

kr2 = DNA.LINE()
#kr2.login(qr=True)
kr2.login(token='Ep9kq9jwuGVsYuWDwx73.GQe1F0FLgkB3suGK5WtUCW.1vsqS2J2TMdJYVWUcv/uwuzriFupMQhVb2qbHn89jVM=')#r3
kr2.loginResult()

kr3 = DNA.LINE()
#kr3.login(qr=True)
kr3.login(token='EpuqV0g0vXu3AsD8xMP1./PGYhVVe4uDle5Q6kp48qq.VH77rMtd6Q2fAsTgRc40uu0+6LY0cMc2UmEXWL+XTg8=')#r4
kr3.loginResult()

kr4 = DNA.LINE()
#kr4.login(qr=True)
kr4.login(token='Epf98A1lMrBKUc7Mgta3.fOtS1/ZYrVfyY2wr74a3uW.VV6dcVX5icu91xE5AI+MwhdUWJ1iRiy8rVxKdDSmn/c=')#r5
kr4.loginResult()

kr5 = DNA.LINE()
#kr5.login(qr=True)
kr5.login(token='EpWdJU86BEPOXnRHsGfd.UC8K+GXOvK/3A1WWSKmQRq.gLi/Sn2ebltEioZNHX2nnX8BISOnU4TSfhzouZFghs0=')#r6
kr5.loginResult()
...
wait = {
    ...
    'message':"""Thx for add""",
    "lang":"JP",
    "comment":"ąµţ๏ℓɨЌ€ by D̶e̶e̶ ✯ »»» http://line.me/ti/p/d6iVx4NFod «««",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
        ...
        if op.type == 26:
            ...
            if "MENTION" in msg.contentMetadata.keys() != None:
                 if wait['kickMention'] == True:
                     contact = kr.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag Me!! Im Busy, ",cName + " Ngapain Ngetag?, ",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja, ", "-_-, ","D̶e̶e̶ ✯ lagi off, ", cName + " Kenapa Tag saya?, ","SPAM PC aja, " + cName, "Jangan Suka Tag gua, " + cName, "Kamu siapa, " + cName + "?", "Ada Perlu apa, " + cName + "?","Tag doang tidak perlu., "]
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                msg.contentMetadata = {'mid': "uacdbc0df971bbda9e5ee6f992ec74088"}
                kr.sendMessage(msg)
                kr.sendText(msg.to,'❂➣ Creator yang manis dan unyu')
                ...
                if admin == []:
                       kr.sendText(msg.to,"The adminlist is empty")
                        ...
                        for mi_d in owner:
                            mc += "❂➣" +kr.getContact(mi_d).displayName + "\n"
                        for mi_d in admin:
                            gh += "❂➣" +kr.getContact(mi_d).displayName + "\n"				
